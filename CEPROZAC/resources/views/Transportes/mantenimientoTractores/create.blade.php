...
<div class="pull-left breadcrumb_admin clear_both">
  ...
  <div class="pull-right">
    <ol class="breadcrumb">
      ...
      <li><a  style="color: #808080" href="{{url('/mantenimiento')}}"> Mantenimiento Tractores</a></li>
    </ol>
  </div>
</div>
    ...
    <div class="col-md-12">
      <div class="block-web">
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header" style="margin-top: -5px;"><strong>Registrar Mantenimiento a Tractor</strong></h2> 
            </div>
            <div class="col-md-4">
        ...
        <div class="porlets-content">
          <form action="{{route('mantenimientoTractores.store')}}" method="post" class="form-horizontal row-border"  parsley-validate novalidate>
            {{csrf_field()}}
       ...
       <div class="form-group">
        <div class="col-sm-offset-7 col-sm-5">
          ...
          <a href="{{url('/mantenimientoTractores')}}" class="btn btn-default"> Cancelar</a>
        </div>
      </div><!--/form-group-->
    </form>
  </div><!--/porlets-content-->
