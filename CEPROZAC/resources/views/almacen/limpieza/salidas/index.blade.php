...
<div class="pull-left breadcrumb_admin clear_both">
  ...
  <div class="pull-right">
    <ol class="breadcrumb">
      ...
      <li class="active">Salidas de Almacén de Limpieza</a></li>
    </ol>
  </div>
</div>
        ...
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-7">
              ...
              <h2 class="content-header " style="margin-top: -5px;">&nbsp;&nbsp;<strong>Salidas de Almacén de Limpieza </strong></h2>
            </div>
            <div class="col-md-5"> 
            ...
            <tbody>
              ...
              <tr class="gradeA">
                ...
                <td><li>{{$metodo->Calcula_Cantidad($salidas->cantidad , $salidas->cantidadUnidad , $salidas->nombreUnidadMedida , $salidas->UnidadNombre)}}</li>
                 ...
                 <td>  
                  <center>
                    <a href="{{URL::action('SalidasAlmacenLimpiezaController@verInformacion',$salidas->idSalida)}}" class="btn btn-primary btn-sm" role="button"><i class="fa fa-eye"></i></a>
 
                  </center>
                </td>              
                <td> 
                  <center>
                    <a href="{{URL::action('SalidasAlmacenLimpiezaController@edit',$salidas->idSalida)}}" class="btn btn-primary btn-sm" role="button"><i class="fa fa-edit"></i></a>  
                  </center>
                </td>
