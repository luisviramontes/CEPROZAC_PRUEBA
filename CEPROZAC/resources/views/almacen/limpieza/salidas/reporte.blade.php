						...
						<div class="btn-group pull-right">
							<b>
								...
								<div class="btn-group" style="margin-right: 10px;">
									...
									<a class="btn btn-sm btn btn-info" href="{{URL::action('SalidasAlmacenLimpiezaController@invoice',$salidas->idSalida)}}" target="_blank" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Registrar nueva Entrada"> <i class="fa fa-print"></i>Imprimir Reporte</a>
