...
<div class="pull-left breadcrumb_admin clear_both">
  ...
  <div class="pull-right">
    <ol class="breadcrumb">
      ...
      <li><a style="color: #808080" href="{{url('/almacen/entradas/limpieza')}}">Entradas de Almacén de Limpieza</a></li>
    </ol> 
  </div> 
</div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="block-web"> 
        ...
        <form action="{{url('/almacen/entradas/limpieza', [$entrada->IdEntrada])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate files="true" enctype="multipart/form-data" accept-charset="UTF-8">
          {{csrf_field()}}
