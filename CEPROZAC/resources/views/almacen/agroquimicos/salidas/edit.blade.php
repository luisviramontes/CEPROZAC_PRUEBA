  ...
  <div class="row">
    <div class="col-md-12">
      <div class="block-web">
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header" style="margin-top: -5px;"><strong>Editar Salida de Agroquímico: {{$salida->fecha}} </strong></h2>
            </div>
        ...
        <form action="{{url('/almacen/salidas/agroquimicos', [$salida->idSalida])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate files="true" enctype="multipart/form-data" accept-charset="UTF-8">
          {{csrf_field()}}
...
<div class="form-group">
  <div class="col-sm-6">
    <input  id="destino_f"  name="destino_f" type="hidden"  maxlength="60"  class="form-control"  placeholder=""/>
  </div>
</div>
...
function save() {
 var z = document.getElementById('registrado').value;
 var alm=document.getElementById('almacen_general').value;
 var inv = document.getElementById('invernadero').value;

 if (z == "si"){
  document.getElementById("destino_f").value = alm;;
}else{
  document.getElementById("destino_f").value =inv;
