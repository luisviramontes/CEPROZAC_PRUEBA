        ...
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header" style="margin-top: -5px;"><strong>Registrar Salida de Agroquímicos</strong>
              </h2>
            </div>
...
<div class="form-group">
  <div class="col-sm-6">
    <input  id="destino_f"  name="destino_f" type="hidden"  maxlength="50"  class="form-control"  placeholder=""/>
  </div>
</div>
