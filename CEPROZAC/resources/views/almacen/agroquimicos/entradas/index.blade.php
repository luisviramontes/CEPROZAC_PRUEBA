          ...
          <table  class="display table table-bordered table-striped" id="dynamic-table">
            ...
            <tbody>
              ...
              <tr class="gradeA">
                ...
                <td>  
                    <center>
                      <a href="{{URL::action('EntradasAgroquimicosController@verEntradaAgroquimicos',$entradas->factura)}}" class="btn btn-primary btn-sm" role="button"><i class="fa fa-eye"></i></a>
