...
<div class="pull-left breadcrumb_admin clear_both">
  ...
  <div class="pull-right">
    <ol class="breadcrumb">
      ...
      <li><a style="color: #808080" href="{{url('/almacen/entradas/materiales')}}">Entradas de Almacén de Materiales</a></li>
    </ol> 
  </div> 
</div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="block-web"> 
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header" style="margin-top: -5px;"><strong>Editar Entrada de Materiales Factura N°: {{$entrada->factura}}</strong></h2>
            </div>
        ...
        <form action="{{url('/almacen/entradas/materiales', [$entrada->idEntradaMaterial])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate files="true" enctype="multipart/form-data" accept-charset="UTF-8">
          {{csrf_field()}}
    ...
    <tfoot>
     ...
     <tr class="gradeA">
      ...
      <td><li>{{$metodo->Calcula_Cantidad($entradas2->cantidad , $entradas2->cantidadUnidad , $entradas2->nombreUnidadMedida , $entradas2->UnidadNombre)}}</li>
       ...
       <td>{{$entradas2->iva}}</td>
       <td>{{$metodo->CALCULA_SUB($entradas2->cantidad , $entradas2->cantidadUnidad , $entradas2->p_unitario, $entradas2->iva,$entradas2->nombreUnidadMedida)}}</td>
     </td>
   </td>
 </tr>    
...
window.onload=function() {
  ...
  for (var i = 1 ; i <= r-1; i++) {
   cantidadnueva=document.getElementById("detalles").rows[i].cells[7].innerHTML;
...
function llenado(){
 ...
 if( provedorv !== "" && empresav !=="" &&entregadov !=="" && recibev!=="" && notav!=="" && preciou!=="" && ivax !== ""){
  ...
  cell8.innerHTML = precio * cantidaden + ivatotal ;
...
function eliminarFila(value) {
  ...
  var cantidadanueva=document.getElementById("detalles").rows[value].cells[7].innerHTML;
