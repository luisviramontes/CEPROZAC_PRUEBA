  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header" style="margin-top: -5px;"><strong>Registrar Entrada de Materiales</strong></h2>
            </div>
     ...
     <div class="form-group">
      ...
      <div class="col-sm-6">
        <select name="entregado" id="entregado" value=""  class="form-control select2" required>  
...
<a class="btn btn-sm btn-success tooltips" href="{{ route('almacen.entradas.materiales.create')}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" target="_blank" title="" data-original-title="Registrar nuevo Material"> <i class="fa fa-plus"></i> Registrar Nuevo Material </a>
