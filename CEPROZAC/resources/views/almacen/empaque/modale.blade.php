<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete2-{{$materiales->idEmpaque}}">
    ...
    <div class="modal-content panel default blue_border horizontal_border_1">
      <div class="modal-body"> 
        <div class="row">
          <div class="block-web">
            <div class="header">
              <h3 class="content-header theme_color">&nbsp;Agregar Stock: {{ $materiales->idEmpaque}}</h3>
            </div>


            <div class="porlets-content" style="margin-bottom: -50px;">
            <form action="{{url('almacenes/empaque/stock', [$materiales->idEmpaque])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate files="true" enctype="multipart/form-data" accept-charset="UTF-8">
                {{csrf_field()}}

                <input type="hidden" name="_method" value="PUT">

                <input type="hidden" value="{{$materiales->idEmpaque}}">
                <div class="form-group">
                  <label  class="col-sm-3 control-label">Agregar Stock<strog class="theme_color">*</strog></label>
                  <div class="col-sm-8">
                  <input name="cantidad" id="cantidades{{$materiales->idEmpaque}}" maxlength="9" type="text" value="1" min="1" max='9999999'" class="form-control" required placeholder="Ingrese la Cantidad" onkeypress=" return soloNumeros(event);" />
                  </div>    
                </div>
                <br> <br>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                  <select name="provedor" id="recibio{{$materiales->idEmpaque}}"   class="form-control select" required>  
               ...
               <div class="form-group">
                ...
                <input type="date" name="fecha2{{$materiales->idEmpaque}}" id="fecha2{{$materiales->idEmpaque}}" value="" class="form-control mask" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                <select name="recibio{{$materiales->idEmpaque}}" id="recibio{{$materiales->idEmpaque}}" value="recibio"  class="form-control select" required>  
             ...
             <div class="form-group">
              ...
              <div class="col-sm-8">
              <select name="entregado_a{{$materiales->idEmpaque}}" id="entregado_a{{$materiales->idEmpaque}}" value=""  class="form-control select" required>  
           ...
           <div class="form-group">
            ...
            <div class="col-sm-8">
            <select name="recibe_alm{{$materiales->idEmpaque}}" id="recibe_alm{{$materiales->idEmpaque}}" value=""  class="form-control select" required>  
                @foreach($empleado as $emp)
                <option value="{{$emp->id}}">
                 {{$emp->nombre}} {{$emp->apellidos}} 
               </option>
         ...
         <div class="form-group">
          ...
          <input name="observaciones{{$materiales->idEmpaque}}" type="text"  maxlength="200" onchange="mayus(this);"  class="form-control" onkeypress=" return soloLetras(event);" value="" placeholder="Ingrese Observaciónes de la Compra"/>
          </div>
        </div>
        <br> <br>
        <div class="form-group">
          ...
          <div class="col-sm-8">
          <input name="factura{{$materiales->idEmpaque}}" id="factura{{$materiales->idEmpaque}}" value="" type="text"  maxlength="10" onchange="mayus(this);"  class="form-control"  value="" placeholder="Ingrese el Número de Factura"/>
       ...
       <div class="form-group"> 
         ...
         <div class="col-sm-8">
         <input name="iva" id="iva{{$materiales->idEmpaque}}" value="0" type="text" class="form-control" onkeypress=" return soloNumeros(event);" placeholder="Ingrese el % IVA del Producto" />
         </div>    
       </div>
       <br> <br>
       <div class="form-group"> 
         ...
         <div class="col-sm-8">
         <input name="ieps" id="ieps{{$materiales->idEmpaque}}" value="0" type="text" class="form-control" onkeypress=" return soloNumeros(event);" placeholder="Ingrese el % IEPS del Producto" />
         </div>    
       </div>  
       ...
       <div class="form-group">
        ...
        <div class="col-sm-8">
        <select name="moneda{{$materiales->idEmpaque}}"  id ="moneda{{$materiales->idEmpaque}}" class="form-control select" data-live-search="true"  value="{{Input::old('moneda')}}">
...
<div class="form-group">
  ...
  <div class="col-sm-8">
   ...
   <button type="submit"onclick="return save({{$materiales->idEmpaque}});" class="btn btn-primary">Agregar</button>
 </div>
</div>
<br> <br>
</div>
...
<script>
  function save($id2)
  {
    ...
    if (document.getElementById('umedida{{$materiales->idEmpaque}}').value != unidadaux){
 ...
 var cantidades = document.getElementById("cantidades{{$materiales->idEmpaque}}");
 var cantidaden = cantidades.value;
 var cantidadth = cantidadaux * cantidaden;
 var u = "";
 var medidaaux = u.concat(cantidadth," ",unidadaux);

 document.getElementById('medidaaux{{$materiales->idEmpaque}}').value=medidaaux;
