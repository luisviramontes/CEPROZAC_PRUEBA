...
<div class="pull-left breadcrumb_admin clear_both">
	<div class="pull-left page_title theme_color">
		<h1>Inicio</h1>
		<h2 class="">Salidas Empaque</h2>
	</div>
	<div class="pull-right">
		<ol class="breadcrumb">
			<li ><a style="color: #808080" href="{{url('/almacen/salidas/empaque')}}">Inicio</a></li>
			<li class="active">Reporte de Salida de Almacén de Empaque</a></li>
		</ol>
	</div>
</div>
						...
						<div class="btn-group pull-right">
							<b>
								...
								<div class="btn-group" style="margin-right: 10px;">
									...
									<a class="btn btn-sm btn-danger tooltips" href="/almacen/salidas/empaque" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Cancelar"> <i class="fa fa-times"></i> Salir</a>

									<a class="btn btn-sm btn btn-info" href="{{URL::action('salidasempaquescontroller@pdfsalidaempaques',$salidas->idSalida)}}" target="_blank" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Registrar nueva Entrada"> <i class="fa fa-print"></i>Imprimir Reporte</a>
