          ...
          <table  class="display table table-bordered table-striped" id="dynamic-table">
            ...
            <tbody>
              ...
              <tr class="gradeA">
                ...
                <td>  
                    <center>
                      <a href="{{URL::action('entradasempaquescontroller@verentradaempaques',$entradas->factura)}}" class="btn btn-primary btn-sm" role="button"><i class="fa fa-eye"></i></a>
                ...
                <td> 
                  <center> 
                    <a href="{{URL::action('entradasempaquescontroller@edit',$entradas->factura)}}" class="btn btn-primary btn-sm" role="button"><i class="fa fa-edit"></i></a>  
                  </center>
                </td>
